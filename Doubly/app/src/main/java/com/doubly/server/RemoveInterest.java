 ...
 */
public class RemoveInterest extends AsyncTask<String,Void,Boolean> {
    // String... params:
    // index 0: interestID
    @Override
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            URL url = new URL("http://ec2-52-42-244-41.us-west-2.compute.amazonaws.com/remove_interest"
