 ...
 */
public class GetInterests extends AsyncTask<String,Void,Boolean> {
    // String... params:
    // index 0: startIndex
    // index 1: endIndex
    // index 2: interest search text
    @Override
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            URL url = new URL("http://ec2-52-42-244-41.us-west-2.compute.amazonaws.com/get_interests"
                    + "/" + params[0]
                    + "/" + params[1]
                    + "/" + params[2]
            );
